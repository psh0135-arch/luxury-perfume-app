      ...
      <main className="mx-auto max-w-[420px] pb-40">
        ...
        <header className="px-6 pt-10 pb-6 animate-fade-in">
          ...
          <button
            ...
            className="mt-5 inline-flex h-11 min-h-[44px] items-center gap-2 rounded-full px-5 text-sm font-semibold tracking-wider text-white shadow-[0_10px_30px_-12px_hsl(340_60%_50%/0.45)] transition-transform active:scale-[0.98] disabled:cursor-not-allowed disabled:opacity-60"
            style={{
              background: "linear-gradient(135deg, hsl(340 80% 78%) 0%, hsl(330 70% 60%) 55%, hsl(320 60% 52%) 100%)",
            }}
          >
            진행 중 이벤트 보기
        ...
        <nav className="border-t border-border bg-background/98 backdrop-blur">
          ...
          <div className="mx-auto max-w-[420px] px-6 py-3">
            <a
              ...
              className="flex h-14 min-h-[44px] w-full items-center justify-center gap-2 rounded-full text-sm font-semibold tracking-[0.15em] text-white shadow-[0_10px_30px_-12px_hsl(340_60%_50%/0.45)] transition-transform active:scale-[0.98]"
              style={{
                background: "linear-gradient(135deg, hsl(340 80% 78%) 0%, hsl(330 70% 60%) 55%, hsl(320 60% 52%) 100%)",
              }}
            >
